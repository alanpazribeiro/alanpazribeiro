...
|:--------------------- |:------------------------------------------------------------------------------------------- |:------------------------------ |
|[Web Scraping com Python](https://github.com/alanpazribeiro/Web-scraping-com-Python.git)|Aplicando a técnica de extração de dados da web em um site de e-commerce com a ferramenta BeautifulSoul e Python.|*pandas, requests, BeautifulSoup*|
